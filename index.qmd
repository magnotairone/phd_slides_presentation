...
## Agenda
  ...
  1. Introduction
  2. Motivation
  3. Regularized Maximum Pseudo-Likelihood Graph Estimator
  4. Algorithms for estimation
  5. Simulations
...
## Motivation 1: Leonardi et al. (2023) {.smaller}
...
![](images/sim/conserv_non_conserv_frondana.png){fig-align="center"}

## Motivation 2: Leonardi et al. (2021) {.smaller}
...
- _INCLUIR NOME DO PACOTE - ainda não escolhi_
...
::: {.column width="60%"}
![](images/sim/ex1_graph.jpg){fig-align="center"}
:::
::::
...
![](images/sim/ex1_10x_tile.jpg){width=80% fig-align="center"}
